# OpenLiberty MicroProfile WebSocket Application
Yet another OpenLiberty MicroProfile Thymeleaf MVC web app...
...
This will create an executable jar file **openliberty-mp-web-socket-example.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/openliberty-mp-web-socket-example.jar
